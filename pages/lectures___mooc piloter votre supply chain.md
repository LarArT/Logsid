...
- Une grande adaptabilité : toutes les natures de produit trouvent un véhicule capable de les transporter (surgelés, fragiles…), et ce quel que soit leur façon de voyager :
	...
	- disposées en vrac, c’est-à-dire sans emballage (céréales, fuel, etc.).
- Seul mode de livraison qui peut s’effectuer partout : villes, campagne, etc.
- Un rapport prix/distance souvent intéressant, mais tout de même plus onéreux que celui du transport maritime.
  
  Ses principaux inconvénients :
- Il est très réglementé en Europe (temps de conduite, de pause, etc.).
- Il est moins attractif que les autres moyens sur longue distance :
...
- un avantage écologique sur les autres modes de transport (et de loin !) : il utilise principalement l’énergie électrique ;
- un coût réduit sur les longues distances, notamment pour les produits lourds et volumineux.
...
- Regional Freighters
	- Boeing 757 C, Boeing 707 F
- Feeders
	- Boeing 737-100, EADS ATR 42-72
- noter que 80 % du fret aérien est réalisé dans des “**Combi**”, c’est-à-dire des **avions de ligne**, contenant à la fois de la marchandise et des voyageurs. Les 20 % restants sont réalisés dans des avions totalement dédiés au fret, dits “**avions-cargos**”
- Ses principaux avantages sont les suivants. Il est :
- illimité en termes de distance et de destination ;
- très rapide, incomparable quant aux autres modes de transport ;
- capable de transporter une volumétrie et une charge importante ;
- capable d’une grande fiabilité et régularité (24h/24, 7j/7) ;
- capable de transporter différentes **unités de chargement spécifiques **au transport aérien (appelées **ULD** pour “**Unit Load Device**”) correspondant aux palettes et conteneurs.
...
- Le transport multimodal : ici la prestation de transport est confiée à un seul opérateur qui pilotera l’ensemble des modes de transport.
  Dans cette organisation, la marchandise peut passer d’une UTI à une autre lors du transbordement (par exemple d’un conteneur à la remorque d’un camion). Pour cela, la marchandise devra alors :
- être déchargée du conteneur, c’est l’action de dépotage ;
- puis être chargée dans la remorque, c’est l’empotage.
- L’étape de transbordement de la marchandise se nomme **rupture de charge**. Plus cette étape est longue, plus la durée de la prestation de transport va s’allonger et donc être coûteuse !
- ce délai, la commande peut être directement préparée en boutique physique, en ville, et non plus seulement par les entrepôts hors agglomération. C’est ce que l’on appelle le **Ship From Store** et c’est encore un facteur de démultiplication des flux.
- enfin, le retour du **Blank Sailing**, terme qui signifie l’annulation complète des escales par les armateurs afin de décongestionner les port
- En complément, les SI favorisent l’échange d’informations interacteurs en temps réel  : offre de transport, documentation réglementaire, géolocalisation, traçabilité des produits, etc. Ce qui peut passer par l’utilisation d’applications dédiées.
  
  La mise en place de ces technologies nécessite un fort investissement pour le transporteur. Cependant en relevant ce challenge, il n’offrira plus qu’une simple prestation de transport mais tout un package de service à ses clients (B2B ou B2C). Cette offre additionnelle peut être retrouvée sous le terme de **servicialisation** et participe activement à la fidélisation des clients.
- [[Planifiez votre mission de transport]]
- [[maîtriser la réglementation administrative]]
