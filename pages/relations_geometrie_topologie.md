# Compte rendu : relations entre géométrie(s) et topologie(s)

**Note préliminaire.** Votre liste contenait « topologie différentielle » deux fois (une fois orthographiée « typologie »), et un terme non identifiable (« Tunium »). Je traite donc sept domaines distincts et j'ignore ce dernier terme — n'hésitez pas à préciser si vous visiez autre chose.

Domaines traités : géométrie euclidienne, géométrie hyperbolique, géométrie des surfaces, géométrie différentielle, géométrie algébrique, topologie différentielle, topologie algébrique.
