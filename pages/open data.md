...
- # dark
  ...
  prq.se
- # arme dans les conflits
  https://itrace.conflictarm.com/Home/Login
- # fond souverain
  https://www.swfinstitute.org/fund-rankings/sovereign-wealth-fund
- # lutte blanchiment, financement terrorisme
  http://www.fatf-gafi.org/fr/publications/?hf=10&b=0&q=FRance&s=desc(fatf_releasedate)
  https://www.financialsecrecyindex.com/en/introduction/fsi-2018-results
- #  force militaire
  https://www.globalfirepower.com/
- # europe 
  https://data.europa.eu/euodp/fr/data/dataset/transparency-register
- # infogreff
  https://opendata.datainfogreffe.fr/page/offre-open-data/
- # corporate around the world 
  https://opencorporates.com/companies?q=Euroyacht+Limited
- # offshore leaks 
  https://offshoreleaks.icij.org/stories?utf8=%E2%9C%93&q=&button=&c=SAU&r=
- # GIS
  https://en.wikipedia.org/wiki/List_of_GIS_data_sources
- # limite d'un pays
  https://gadm.org/download_country_v3.html
- # modèle d'élévation numérique (Digital Elevation Model ou DEM) 
  http://dwtkns.com/srtm/
- # oNatural Earth ou DIVA-GIS : données à l'échelle mondiale
...
- # obesite
  https://www.worldobesity.org/data/obesity-data-repository/resources/charts/
- # polution
  https://waqi.info/
- # general
...
- # france 
  ...
  http://www.observatoire-opendata.fr/
...
- # google 
  ...
  https://framalibre.org/annuaires/open-data
- # think  tank
  https://repository.upenn.edu/think_tanks/
- # google
  "non paper" UnOrganisme filetype:pdf
...
- # carte réseau haute tension france
...
- # global terrorism database
  www.start.umd.edu/gtd/search/Results.aspx?search=&sa.x=54&sa.y=3
- # consommation d'électricité
  https://donnees.banquemondiale.org/indicateur/EG.USE.ELEC.KH.PC
- # consulté la fréquence de lecture des articles de wikipedia
  https://tools.wmflabs.org/pageviews
- # cout internet par pays 
  www.atlasandboots.com/remote-jobs/countries-with-the-cheapest-internet-world/
  https://www.cable.co.uk/mobiles/worldwide-data-pricing/
  http://www.itu.int/itu-d/tnd-map-public/
- # usage internet par pays avec croissance
  https://data.worldbank.org/indicator/it.NET.user.ZS
- # geodemograpgie insee
...
- # data visualization : economic resources, military capability, resilience, future resoureces 
  https://power.lowyinstitute.org/countries.php?profile=CN
- # polution air
