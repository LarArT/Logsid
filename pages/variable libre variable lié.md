Tags:: α-equivalent, formule close,

- Définition 1.2.16
	- - On dit que les formules F et G sont **α-équivalentes** si elles sont (syntaxiquement) identiques à un renommage près des occurrences liées des variable
- Définition 1.2.19
